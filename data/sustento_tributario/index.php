...
<html lang="es">
	...
	<body class="skin-1">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Sustento Tributario</li>
                        </ul>
                    </div>
							...
							<div class="col-xs-12 col-sm-12 widget-container-col">
								<div class="widget-box">
									<div class="widget-header">
										<h5 class="widget-title">Sustento Tributario</h5>
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="row">
												<form class="form-horizontal" role="form" rol="form" action="" method="POST" id="form_sustento">										
													<div class="col-xs-12">
														<div class="col-sm-6">
															<div class="row">
																<div class="col-sm-12">
		...
		<script src="sustento_tributario.js"></script>
