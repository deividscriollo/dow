	...
	//////////////para tablas//////////
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        ...
	        url: 'xml_tipo_producto.php',
	        datatype: "xml",
	        height: 250,
	        colNames:['ID','DESCRIPCIÓN','FECHA'],
	        colModel:[
	            {name:'id_tipo',index:'id_tipo', width:60, sorttype:"int", editable: true, hidden: true, editoptions: {readonly: 'readonly'}},
	        ...
	        editurl: "tipo_producto.php",
	        caption: "LISTA TIPO DE PRODUCTO"
	    });
	    ...
	    },
	    {
			...
			if(response.responseText == 3){
	        		...
	        		if(response.responseText == 1){	
	        			$("#descripcion").val("");
	        			return [false,"Error.. El tipo de producto ya existe"];
		        	}	
	        	}
	        },
	    },
