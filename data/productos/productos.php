<?php
	...
	if($_POST['tipo'] == "g"){
		...
		if($data == 0){
			...
			$valor3 = number_format($_POST['txt_11'], 2, '.', '');
    		if (strpos($cadena, $buscar) ==  FALSE) {
				$sql = "update productos set codigo='".$_POST["txt_1"]."',codigo_barras='".$_POST["txt_8"]."',descripcion='".strtoupper($_POST['txt_2'])."',precio='$valor1',utilidad_minorista='".$_POST["txt_3"]."',utilidad_mayorista='".$_POST["txt_10"]."',precio_minorista='$valor2',precio_mayorista='$valor3',id_tipo='".$_POST["txt_5"]."',stock='".$_POST["txt_12"]."',id_categoria='".$_POST["txt_6"]."',id_marca='".$_POST["txt_13"]."',id_bodega='".$_POST["txt_7"]."',id_unidad='".$_POST["txt_14"]."',facturar_existencia='$sin_existencia',cantidad_minima='".$_POST["txt_16"]."',cantidad_maxima='".$_POST["txt_17"]."',id_series_venta='$producto_series',expiracion='$expiracion_producto',comentario='".$_POST["txt_18"]."',imagen='default.png',estado='$producto_activo',id_porcentaje_iva='".$_POST["iva_producto"]."',id_usuario ='$id_user', incluye_iva='".$_POST['incluye_iva']."',descuento='".$_POST["descuento"]."' where id_productos = '".$_POST["txt_0"]."'";					
			}else{					
				$resp = img_64("img",$_POST['img'],'png',$id);					
				if($resp == "true"){				
					$sql = "update productos set codigo='".$_POST["txt_1"]."',codigo_barras='".$_POST["txt_8"]."',descripcion='".strtoupper($_POST['txt_2'])."',precio='$valor1',utilidad_minorista='".$_POST["txt_3"]."',utilidad_mayorista='".$_POST["txt_10"]."',precio_minorista='$valor2',precio_mayorista='$valor3',id_tipo='".$_POST["txt_5"]."',stock='".$_POST["txt_12"]."',id_categoria='".$_POST["txt_6"]."',id_marca='".$_POST["txt_13"]."',id_bodega='".$_POST["txt_7"]."',id_unidad='".$_POST["txt_14"]."',facturar_existencia='$sin_existencia',cantidad_minima='".$_POST["txt_16"]."',cantidad_maxima='".$_POST["txt_17"]."',id_series_venta='$producto_series',expiracion='$expiracion_producto',comentario='".$_POST["txt_18"]."',imagen='".$id.".png',estado='$producto_activo',id_porcentaje_iva='".$_POST["iva_producto"]."',id_usuario ='$id_user', incluye_iva='".$_POST['incluye_iva']."',descuento='".$_POST["descuento"]."' where id_productos = '".$_POST["txt_0"]."'";
				}
				else{
					$sql = "update productos set codigo='".$_POST["txt_1"]."',codigo_barras='".$_POST["txt_8"]."',descripcion='".strtoupper($_POST['txt_2'])."',precio='$valor1',utilidad_minorista='".$_POST["txt_3"]."',utilidad_mayorista='".$_POST["txt_10"]."',precio_minorista='$valor2',precio_mayorista='$valor3',id_tipo='".$_POST["txt_5"]."',stock='".$_POST["txt_12"]."',id_categoria='".$_POST["txt_6"]."',id_marca='".$_POST["txt_13"]."',id_bodega='".$_POST["txt_7"]."',id_unidad='".$_POST["txt_14"]."',facturar_existencia='$sin_existencia',cantidad_minima='".$_POST["txt_16"]."',cantidad_maxima='".$_POST["txt_17"]."',id_series_venta='$producto_series',expiracion='$expiracion_producto',comentario='".$_POST["txt_18"]."',imagen='default.png',estado='$producto_activo',id_porcentaje_iva='".$_POST["iva_producto"]."',id_usuario ='$id_user', incluye_iva='".$_POST['incluye_iva']."',descuento='".$_POST["descuento"]."' where id_productos = '".$_POST["txt_0"]."'";
				}
