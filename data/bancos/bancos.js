	...
	//////////////para tablas//////////
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        ...
	        datatype: "xml",
	        height: 250,
	        colNames:['ID','CODIGO','NOMBRE BANCO','FECHA'],
	        colModel:[
	            {name:'id_bancos',index:'id_bancos', width:60, sorttype:"int", editable: true, hidden: true, editoptions: {readonly: 'readonly'}},
	            {name:'codigo',index:'codigo',width:150, editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}},
	            {name:'nombre_banco',index:'nombre_banco',width:150, editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}},
	    ...
	    },
	    {
			...
			if(response.responseText == 3){
	        		...
	        		if(response.responseText == 1){	
	        			$("#nombre_banco").val("");
	        			return [false,"Error.. La nombre del Banco ya existe"];
		        	}	
	        	}
	        },
	    },
