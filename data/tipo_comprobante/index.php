...
<html lang="es">
	...
	<body class="skin-1">
							...
							<div class="col-xs-12 col-sm-12 widget-container-col">
								<div class="widget-box">
									<div class="widget-header">
										<h5 class="widget-title">Tipos de Comprobante</h5>
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="row">
												<form class="form-horizontal" role="form" rol="form" action="" method="POST" id="form_tipo_comprobante">										
													<div class="col-xs-12">
														<div class="col-sm-6">
															<div class="row">
																<div class="col-sm-12">
											...
											<div class="row">
												<div class="col-xs-12">
													...
													<div>
														<table id="td_comprobante" class="table table-striped table-bordered table-hover">
															<thead>
																<tr>
																	<th>Código</th>
		...
		<script src="tipo_comprobante.js"></script>
