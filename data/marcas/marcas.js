	...
	//////////////para tablas//////////
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        ...
	        colModel:[
	            {name:'id_marca',index:'id_marca', width:60, sorttype:"int", editable: true, hidden: true, editoptions: {readonly: 'readonly'}},
	            {name:'nombre_marca',index:'nombre_marca',width:150, editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}},
	    ...
	    },
	    {
			...
			if(response.responseText == 3){
	        		...
	        		if(response.responseText == 1){	
	        			$("#nombre_marca").val("");
	        			return [false,"Error.. La Marca ya existe"];
		        	}	
	        	}
	        },
	    },
